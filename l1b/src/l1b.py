...
class l1b(initL1b):
    ...
    def restoration(self,toa,gain):
        ...
        """
        toa = (toa*gain)
        self.logger.debug('TOA in radiances after gain application ' + str(toa[1,-1]) + ' [mW/m2/sr]')
        return toa
    ...
    def plotL1bToa(self, toa_l1b, outputdir, band):
        ...
        ax.set_title(f"Equalization = False for {band}") # Modification of the title depending if there is equalization or not
